...
<div id="tf-home" class="text-center">
    <div class="overlay">
        <div class="content">
            ...
            @if (!$signedIn)
                <a href="{{ route('jobs.index') }}" class="massive ui inverted green button">Харах</a>
                <a href="{{ route('jobs.create') }}" class="massive ui inverted orange button">Ажлын байр үүсгэх</a>
            @else
                <a href="{{ route('jobs.index') }}" class="massive ui inverted green button">Харах</a>
                <a href="{{ route('jobs.create') }}" class="massive ui inverted orange button">Ажлын байр үүсгэх</a>
            @endif
